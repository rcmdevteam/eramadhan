<header class="{{ config('backpack.base.header_class') }}">
  ...
  <a class="navbar-brand font-weight-bold text-dark text-uppercase" href="{{ url(config('backpack.base.home_link')) }}" title="{{ config('backpack.base.project_name') }}" style="opacity: 1;">
